...
def scrape_rmp_profs(school_name, sid, output_file, sleep_max = 1, write_output = False):
...
# mini = scrape_rmp_profs(school_name, sid, "rmp_data_mini.json", sleep_max = 1.5, write_output = True)